...
//   const ContractFactory = await ethers.getContractFactory("NumberGuessingGame");
//   const vrnPortAddress = "0x9984748bb67825e9e1009A4412B42d0d765ef155"; // 替换为 IVRNPort 合约地址
//   const contract = await ContractFactory.deploy(vrnPortAddress);
